<template>
  <main class="home">
    ...
    <section class="center" role="main">
      <h1 class="title">以羽为眸，千风为刃· 秧秧</h1>
    ...
    >
      <div class="inner container">
        <div class="center">
          <div class="slogan">风会记得，你曾驻足于此。</div>
          <div class="meta">
            © <span>{{ year }}</span> 秧秧电子设定集 · 制作：霜落天亦
          </div>
        </div>
      </div>
    </footer>
...
// ========== 打字机文案 ==========
// 适合秧秧风格的副标题（偏长句，已为打字器准备）
const lines = [
  "褪世家华裳，心怀柔肠，化羽护人间灯芒",
  "共振风息长，鞘隐锋芒，出刃佑少女心芳",
  "我曾亲身感受过末日来临的绝望，所以才要更努力的守护这片安宁",
  "一缕流息，万千回响",
  "她是微风，亦是利刃",
  "自瑝珑启程，收集世间所有的声音",
  "为守护珍视之物而歌的云雀",
